...
export const aboutData: Record<AvailableLanguages, Record<string, any>> = {
  english: {
    ...
    p2: "Proficient working with Agile ways of working such as Scrum and Kanban, experience working with computer systems, data structures, analysing system requirements and developing Web-based applications.",
